        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:col-span-2 flex flex-col gap-1">
              <Label htmlFor="name" className="text-sm font-medium">Tên loại phòng</Label>
              <Input id="name" className="w-full" {...register("name")} />
              {errors.name && <p className="text-xs text-destructive mt-1">{errors.name.message}</p>}
            </div>

            <div className="flex flex-col gap-1">
              <Label htmlFor="price" className="text-sm font-medium">Giá mỗi đêm (VND)</Label>
              <Input id="price" type="number" step="0.01" className="w-full" {...register("price", { valueAsNumber: true })} />
              {errors.price && <p className="text-xs text-destructive mt-1">{errors.price.message}</p>}
            </div>

            <div className="flex flex-col gap-1">
              <Label htmlFor="areaM2" className="text-sm font-medium">Diện tích (m²)</Label>
            ...
            <div className="flex flex-col gap-1">
              <Label htmlFor="adultCapacity" className="text-sm font-medium">Sức chứa người lớn</Label>
            ...
            <div className="flex flex-col gap-1">
              <Label htmlFor="childrenCapacity" className="text-sm font-medium">Sức chứa trẻ em</Label>
